    ...
    <footer className="py-20">
      <div className="max-w-4xl mx-auto px-6 flex flex-col items-center gap-8">
        ...
        <div className="flex items-center gap-6">
          <a
            href="https://github.com/vivekkppatel"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/vivekkppatel/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-neutral-400 hover:text-neutral-700 dark:hover:text-white transition-colors"
            aria-label="LinkedIn"
          ...
          <a
            href="https://www.instagram.com/vivekkppatel"
            target="_blank"
            rel="noopener noreferrer"
            className="text-neutral-400 hover:text-neutral-700 dark:hover:text-white transition-colors"
          ...
          <a
            href="mailto:vivekwork.patel@gmail.com"
            className="text-neutral-400 hover:text-neutral-700 dark:hover:text-white transition-colors"
            aria-label="Email"
          >
            <Mail size={32} />
        ...
        <div className="w-full border-t border-neutral-200 dark:border-neutral-800 pt-6">
          <p className="text-xs text-neutral-400 dark:text-neutral-600 text-center">
            © {new Date().getFullYear()} Vivek Patel
          </p>
        </div>
      </div>
    </footer>
